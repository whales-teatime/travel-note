...
type Feedback = { id: string; category: string; message: string; likes: number; createdAt: string; photoData?: string | null; comments?: FeedbackComment[] };
