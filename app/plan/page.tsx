...
export default function Home(){
  ...
  const applyStoredPlan=useCallback((data:StoredPlan,editToken?:string,permission?:boolean,adminAuthenticated=false)=>{
    ...
    const settings={title:data.title,destination:data.destination,startDate:data.startDate,endDate:data.endDate,people:data.people,editPolicy:data.editPolicy==='all'?'all':data.editPolicy==='password'?'password':'owner' as EditPolicy,mapProvider,destinations:Array.isArray(data.destinations)&&data.destinations.length?data.destinations:undefined};
  ...
  const savePlan=async(silent=false)=>{
    ...
    const payload={title:tripSettings.title,destination:tripSettings.destination,startDate:tripSettings.startDate,endDate:tripSettings.endDate,people:tripSettings.people,editPolicy:tripSettings.editPolicy,mapProvider:tripSettings.mapProvider,destinations:tripSettings.destinations||[],stops};
    try{
